...
jockey_match_expected_data = pd.DataFrame(
    {
        "race_time": [
            TEST_DATETIME + timedelta(hours=12),
            TEST_DATETIME + timedelta(hours=12),
        ...
        "horse_name": ["Horse B", "Horse C", "Horse D", "Horse E"],
        "age": [4, 5, 6, 7],
        "horse_sex": ["Gelding", "Colt", "Mare", "Filly"],
        "draw": [2, 3, 4, 5],
        "headgear": [
            np.nan,
            np.nan,
        ...
        "weight_carried": ["10-5", "10-10", "11-0", "11-5"],
        "weight_carried_lbs": [145, 150, 154, 159],
        "extra_weight": [None, None, None, None],
        "jockey_claim": [None, None, None, None],
        "finishing_position": ["2", "3", "4", "5"],
        "total_distance_beaten": [0.1, 3.25, 4.75, 999.0],
        "industry_sp": ["3/1", "4/1", "5/1", "6/1"],
        "betfair_win_sp": [4.0, 5.0, 6.0, 7.0],
        "betfair_place_sp": [3.0, 4.0, 5.0, 6.0],
        "official_rating": [50, 55, 60, 65],
        "ts": [45, 50, 55, 60],
        "rpr": [45, 50, 55, 60],
        "tfr": [np.nan, 60.0, 70.0, 80.0],
        "tfig": [40, 50, 60, 70],
        "in_play_high": [None, None, None, None],
        "in_play_low": [11.0, 12.0, 13.0, 14.0],
        "in_race_comment": ["Prominent", "Prominent", "Held up", "Towards rear"],
        "tf_comment": [
            "this is a comment for timeform horse b",
            "this is a comment for timeform horse c",
            "this is a comment for timeform horse d",
        ...
        "tfr_view": ["questionable", "positive", "neutral", "neutral"],
        "course_id": [200, 300, 400, 500],
        "horse_id": [200, 300, 400, 500],
        "jockey_id": [1, 2, 3, 4],
        "trainer_id": [200, 300, 400, 500],
        "owner_id": [200, 300, 400, 500],
        "sire_id": [200, 300, 400, 500],
        "dam_id": [200, 300, 400, 500],
        "unique_id": ["2", "3", "4", "5"],
    }
)

jockey_unmatched_expected_data = pd.DataFrame(
    {
        "entity": ["jockey"],
        "race_timestamp": [TEST_DATETIME + timedelta(hours=12)],
        "name": ["Jockey A"],
        "debug_link": ["https://www.racingpost.com/results/some_link"],
    }
)
