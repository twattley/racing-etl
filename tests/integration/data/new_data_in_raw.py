        ...
        "data": pd.DataFrame(
            {
                ...
                "distance": ["2m3f", "2m3f", "2m3f", "2m3f", "2m3f", "2m3f"],
                "going": [
                    "Yielding To Soft",
                    "Yielding To Soft",
                    "Yielding To Soft",
        ...
        "data": pd.DataFrame(
            {
                ...
                "jockey_claim": [np.nan, np.nan, np.nan],
                "trainer_name": [
                    "Trainer A",
                    "Trainer B",
                    "Trainer C",
                ],
                "owner_name": ["Owner A", "Owner B", "Owner C"],
                "weight_carried": ["10-0", "10-5", "10-10"],
                "draw": [1, 2, 3],
                "finishing_position": [1, 2, 3],
                "age": [3, 4, 5],
                "official_rating": [45, 50, 55],
                "ts": [40, 45, 50],
                "rpr": [40, 45, 50],
                "industry_sp": ["2/1", "3/1", "4/1"],
                "extra_weight": [np.nan, np.nan, np.nan],
                "headgear": ["b", np.nan, np.nan],
                "in_race_comment": [
                    "Led",
                    "Prominent",
                    "Prominent",
                ],
                "sire_name": ["Sire A", "Sire B", "Sire C"],
                "dam_name": ["Dam A", "Dam B", "Dam C"],
                "dams_sire": [
                    "Dams Sire A",
                    "Dams Sire B",
                    "Dams Sire C",
                ...
                "race_time": ["12:00", "12:00", "12:00"],
                "race_timestamp": [
                    TEST_DATETIME + timedelta(hours=12),
                    TEST_DATETIME + timedelta(hours=12),
                    TEST_DATETIME + timedelta(hours=12),
                ],
                "conditions": ["(4yo+)", "(4yo+)", "(4yo+)"],
                "distance": ["2m3f", "2m3f", "2m3f"],
                "going": [
                    "Yielding To Soft",
                    "Yielding To Soft",
                    "Yielding To Soft",
                ...
                "number_of_runners": [3, 3, 3],
                "total_prize_money": [9, 9, 9],
                "first_place_prize_money": [6, 6, 6],
                "currency": ["EURO", "EURO", "EURO"],
                "country": ["UK", "UK", "UK"],
                "surface": ["Turf", "Turf", "Turf"],
                "tfr": ["+", "?", "p60+"],
                "tfig": [30.0, 40.0, 50.0],
                "betfair_win_sp": [3.0, 4.0, 5.0],
                "betfair_place_sp": [2.0, 3.0, 4.0],
                "in_play_prices": ["10/-", "-/11", "-/12"],
                "tf_comment": [
                    "this is a comment for timeform horse a",
                    "this is a comment for timeform horse b",
                    "this is a comment for timeform horse c",
                ],
                "hcap_range": ["(0-55)", "(0-60)", "(0-65)"],
                "age_range": ["3-4yo", "4yo+", "5yo+"],
                ...
                "meeting_id": [1, 2, 3],
                "course_id": [100, 200, 300],
                "horse_id": [100, 200, 300],
                "sire_id": [100, 200, 300],
                "dam_id": [100, 200, 300],
                "trainer_id": [100, 200, 300],
                "jockey_id": [100, 200, 300],
                "owner_id": [100, 200, 300],
                "race_id": [1, 2, 3],
                "unique_id": [1, 2, 3],
                "created_at": [
...
new_data_in_raw_expected_data = pd.DataFrame(
    {
        "race_time": [
            TEST_DATETIME + timedelta(hours=12),
            TEST_DATETIME + timedelta(hours=12),
