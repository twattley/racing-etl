...
from tests.integration.data.new_data_in_raw import new_data_in_raw, new_data_in_raw_expected_data
...
def test_adds_missing_entity(load_test_data, fetch_test_data, assert_data_equal):
    ...
    rejected_data = fetch_test_data("SELECT * FROM staging.transformed_performance_data_rejected")
