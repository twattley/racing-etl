...
class TodaysDataQuality(IDataQualityInterface):
    ...
    def check_data_quality(self) -> bool:
        ...
        if not self._check_todays_racecard_links():
            I(
                f"Failed todays racecard links data quality check in {self.schema}.days_racecards_links"
            )
            return False
    ...
    def _check_todays_racecard_links(self) -> bool:
        ...
        self._record_data_quality_counts(todays_data, "days_racecards_links")
